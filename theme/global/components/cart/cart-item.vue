      ...
      <fdk-accounts>
        <template scope="accountsData">
          <div class="bag">
            ...
            <div class="links">
              <a @click="modalHandle()"> REMOVE PRODUCT </a>
              <a
            ...
            >
              ...
              <div class="btn-container flex-center">
                <a class="no-btn bold-sm" @click="confirmModalvisible = false"
                  >No</a
                >
                <a class="yes-btn bold-sm" @click="removeFromCart">Yes</a>
              </div>
            </modal>
          </div>
        </template>
