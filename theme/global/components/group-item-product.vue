    ...
    <fdk-link :link="generateLink">
      ...
      <div class="details-wrapper">
        <div class="details">
          ...
          <div class="price">
            <span v-if="card.price && card.price.effective">
              {{ getPrice(card, "effective") }}
            </span>
            <span v-if="hasDiscount(card)" class="price-marked strikethrough">
              {{ card.price.marked.currency_symbol }}
              {{ card.price.marked.max }}
            </span>
            <span class="product-total-discount" v-if="hasDiscount(card)">
              <span class="">{{ card.discount }}</span>
            </span>
            <div class="item-selection" v-if="validateCardType()">
