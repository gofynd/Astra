        ...
        >
          ...
          <div>
            <div class="product-desc">
              ...
              <h5 class="wrap-text">
                <b
                  class="bold-xs cl-Mako brand-name"
              ...
              <div>
                <span class="regular-xs cl-Profit">
                  <span
                    v-if="product.price && product.price.effective"
                  >
...
.discount-container {
  ...
  height: 25px;
  .discount {
    background: url("../../../assets/images/special-badge.png") bottom left
      no-repeat;
  }
  .special-offer-text {
    text-align: left;
