  ...
  <div class="plp-wrapper">
    ...
    <template v-else-if="context && context.items">
      <div class="breadcrumbs br-desktop caption-normal font-body">
        ...
        <span
          ><fdk-link :link="'/collections'">Collections</fdk-link>&nbsp; /
          &nbsp;</span
        >
      ...
      <div class="content-wrapper">
        ...
        <div class="right">
          ...
          <div class="plp__desc" v-if="context.product_meta.description">
            <div class="plp__desc--content caption-normal font-body">
              {{
                isDescCollapsed
                  ? `${context.product_meta.description.substring(0, 600)}...`
                  : context.product_meta.description
              }}
            </div>
            <button
              class="btn-secondary plp__desc--read-more font-body"
              v-if="context.product_meta.description.length > 600"
