<template>
  <div v-if="render" :style="dynamicStyles">
    ...
    <div class="video-container" @click="phoneClick">
      <skeleton
        v-show="isLoading"
        :aspectRatio="16 / 9"
      ...
      >
        ...
        <div class="overlay__content">
          <div @click.stop="playVideo()" class="play-button">
            <svg-wrapper :svg_src="'play'"></svg-wrapper>
          </div>
        </div>
      </div>
      <div class="pause-button" @click="closeVideo" v-if="!showOverlay">
...
export default {
  ...
  methods: {
    ...
    phoneClick() {
      if (window.innerWidth < 820 && !this.showOverlay) {
        this.closeVideo();
      }
    },
  },
